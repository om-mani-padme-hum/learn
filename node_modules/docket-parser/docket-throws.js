/**
 * @class docket.DocketThrows
 * @author Rich Lowe
 * @copyright 2018 Rich Lowe
 * @added v0.3.0
 * @description Data model class for storing method and function signature throwed error details.
 */
class DocketThrows {
  /**
   * @signature new DocketThrows([data])
   * @added v0.3.0
   * @param data Object
   * @returns DocketThrows
   * @description Returns a new [DocketThrows] instance, initializing with any key/value pairs provided in `data` with keys 
...
module.exports.DocketThrows = DocketThrows;
